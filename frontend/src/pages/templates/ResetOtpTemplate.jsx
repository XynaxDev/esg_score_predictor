...
export default function ResetOtpTemplate() {
  ...
  const send = async () => {
    ...
    const template_id = import.meta.env.VITE_EMAILJS_TPL_RESET || import.meta.env.VITE_EMAILJS_TEMPLATE_ID
    ...
    try {
      ...
      const payload = {
        ...
        template_params: {
          ...
          otp_code: code,
          message: 'Use this 6‑digit OTP to reset your password. It expires in 15 minutes.'
        }
      }
    ...
    <div className="min-h-[60vh] px-6 lg:px-8 py-10">
      <div className="mx-auto max-w-4xl grid md:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-dark-800 bg-dark-900/70 p-6">
          <h2 className="text-lg font-semibold text-gray-100 mb-2">Reset Password (OTP)</h2>
          <p className="text-sm text-gray-400 mb-4">6‑digit code with clear steps and security tips.</p>
          ...
          <div className="bg-[#0b1220] p-4 rounded-lg border border-dark-800">
            <div className="bg-[#0f172a] rounded-xl border border-[#1f2937] overflow-hidden">
              <div className="p-5">
                ...
                <h3 className="mt-4 text-gray-100 text-xl font-bold">Password reset code</h3>
                <p className="mt-2 text-gray-300">Enter the following 6‑digit code to reset your password:</p>
